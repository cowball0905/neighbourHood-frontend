...
import { parseURL, withoutBase, joinURL, getQuery, withQuery, joinRelativeURL, parsePath, withLeadingSlash, withoutTrailingSlash, withTrailingSlash, decodePath } from 'file:///Users/8989ken/git/xavier-backend/neighbourHood-frontend/node_modules/ufo/dist/index.mjs';
...
import { createHooks } from 'file:///Users/8989ken/git/xavier-backend/neighbourHood-frontend/node_modules/nitropack/node_modules/hookable/dist/index.mjs';
...
import { SourceMapConsumer } from 'file:///Users/8989ken/git/xavier-backend/neighbourHood-frontend/node_modules/nitropack/node_modules/source-map/source-map.js';
import { createRouterMatcher } from 'file:///Users/8989ken/git/xavier-backend/neighbourHood-frontend/node_modules/@nuxtjs/i18n/node_modules/vue-router/vue-router.node.mjs';
...
import { isVNode, isRef, toValue } from 'file:///Users/8989ken/git/xavier-backend/neighbourHood-frontend/node_modules/vue/index.mjs';
import _wH6JrtIxmaSoA8lCPWFnE9z4lQeXW6H5z3l5aymEQw from 'file:///Users/8989ken/git/xavier-backend/neighbourHood-frontend/node_modules/@nuxt/vite-builder/dist/fix-stacktrace.mjs';
...
const errorHandler$0 = (async function errorhandler(error, event, { defaultHandler }) {
	...
	if (!globalThis._importMeta_.test && typeof html === "string") {
		...
		if (typeof prettyResponse.body === "string") {
			return send$2(event, html.replace("</body>", `${generateErrorOverlayHTML(prettyResponse.body, { startMinimized: 300 <= status && status < 500 })}</body>`));
		}
	}
...
const locale_en_46json_ef3b6461 = {
...
const locale_zh_46json_0a73f464 = {
  ...
  en: [
    {
      ...
      load: () => Promise.resolve(locale_en_46json_ef3b6461),
      cache: true
    }
  ],
  zh: [
    {
      ...
      load: () => Promise.resolve(locale_zh_46json_0a73f464),
      cache: true
    }
  ]
};
...
const _JCiN1CBZikAM0iqo0si5zwwafSNb4s8i12Bx07JD_QU = defineNitroPlugin(async (nitro) => {
  ...
  nitro.hooks.hook("render:before", async (context) => {
    ...
    if (!url.pathname.includes("/_i18n/LQOie7Xh") && !isExistingNuxtRoute(path)) {
      return;
    }
...
const _lazy_FpRrgW = () => Promise.resolve().then(function () { return renderer; });
